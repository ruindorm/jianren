...
| A single chapter, plain text | \`$SITE_URL/en/txt/ch01.txt\` (ch00–ch13) |
| A single chapter, web page | \`$SITE_URL/en/ch01.html\` (ch00–ch13) |
...
| $R2 | \`$SITE_URL/txt/ch01.txt\`（ch00–ch13） |
| $R3 | \`$SITE_URL/ch01.html\`（ch00–ch13） |
